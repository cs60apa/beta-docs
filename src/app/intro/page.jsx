...
export default function Intro() {
  return (
    <div className="relative max-w-screen-xl mx-auto md:flex md:flex-row">
      <div className="sticky hidden md:flex w-[284px] md:shrink-0 top-[121px] max-h-full md:flex-col md:border-r-1 md:justify-between dark:bg-[#292C31] bg-[#F7F4F3]">
        <div className="overflow-hidden relative">
          <nav className="max-h-full flex flex-col pr-2 pb-4">
            <div
              aria-hidden="true"
      ...
      <div className="md:flex-row hidden md:flex">
        <div className="md:flex-row md:space-y-8 ">
          <p className="text-[#868D9A] md:ml-5">
            {" "}
            <BiMenu size={25} />
          </p>
        ...
        <div className="md:ml-6 md:mt-60 lg:mt-80">
          <p className="text-[#868D9A] ">
            {" "}
            <IoIosArrowBack size={45} />
          </p>
        </div>
      </div>
      <article className="w-full min-w-0 max-w-6xl mt-2 px-1 md:mx-10 pb-10 dark:text-[#E2E3E7] select-text">
        <div className="flex-col md:flex-row md:mb-4 mb-2 ">
          <div className="flex space-x-1">
            <span className="text-[#868D9A]">
              <IoHome /> 
              <Links url="/" text="" />
            </span>
            <span className="mt-1">
            ...
            <span className="text-[#84a0ef] md:text-sm hover:text-[#e3796a] hover:border-b hover:border-[#e3796a]">
              <Links url="" text="The Javascript language" />
            </span>
            <span className="mt-1">
              {" "}
              <HiOutlineArrowNarrowRight />{" "}
          ...
          <div className="flex text-[#868D9A] mt-2 md:mt-0">
        ...
        <div className="prose prose-vercel max-w-none">
          ...
          <div className="space-y-3">
            ...
            <p>
              ...
              called{" "}
              <a href="" className="text-[#84a0ef] hover:text-[#e3796a]">
                Java.
              </a>
            </p>
            <div className="border-4 rounded dark:border-[#35383F]">
              ...
              <p className="md:my-3 mt-2 mx-3 mb-2 md:mx-5">
                ...
                language with its own specification called ECMAScript, and now
